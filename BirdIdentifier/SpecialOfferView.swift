            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 8) {
                    ...
                    HStack(spacing: 16) {
                        ...
                        Button {
                            if let url = URL(string: "https://turkerkizilcik.com/birdid/privacy-policy.html") {
                        ...
                        Button {
                            if let url = URL(string:  "https://turkerkizilcik.com/birdid/terms-of-use.html") {
                                UIApplication.shared.open(url)
                            }
                        } label: {
                            Text("Terms")
...
private struct FeatureRowSpecialOffer: View {
    let icon: String
    let title: String
    let subtitle: String
