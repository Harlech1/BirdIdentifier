    ...
    var body: some View {
        NavigationStack {
                    ...
                    Button(action: {
                        ...
                        HStack {
                            VStack(alignment: .leading, spacing: 4) {
                                Text(premiumManager.isPremium ? "Birdi Premium Activated" : "Birdi Premium")
                ...
                Section(header: Text("Help us to grow")) {
                    TKSettingsView(items:
                                    [.init(icon: "square.and.arrow.up",
                                           ...
                                           title: "Share App",
                                           action: {
                        TKSettingsView.shareAppLink(appUrl: "https://apps.apple.com/us/app/birdi-ai-bird-identifier/id6740003551")
                    }), .init(icon: "star.fill", iconColor: .white, iconBackgroundColor: .orange, title: "Rate Us", action: {
                        TKSettingsView.openAppStoreForRating(appId: "6740003551")
                    }), .init(icon: "envelope.fill", iconColor: .white, iconBackgroundColor: .blue, title: "Feedback", action: {
                        TKSettingsView.sendEmail(to: "developerturker1@gmail.com", subject: "Feedback on Birdi", body: "Hello, I'd like to share some feedback about...")
                    })])
                }

                Section(header: Text("Documents")) {
                    NavigationLink(destination: TKDocumentsView(type: .privacyPolicy, appName: "Birdi", developerName: "Türker Kızılcık", email: "developerturker1@gmail.com")){
                        Label(
                    ...
                    NavigationLink(destination: TKDocumentsView(type: .termsOfUse, appName: "Birdi", developerName: "Türker Kızılcık", email: "developerturker1@gmail.com")){
                        Label(
            ...
            .fullScreenCover(isPresented: $showPaywall) {
                CustomPaywallView() // will put the thingy
